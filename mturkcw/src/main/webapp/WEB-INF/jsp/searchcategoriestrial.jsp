...
<body class="formstyle">
	<form:form action="https://boston.lti.cs.cmu.edu/boston-2-13/searchResultsBERTTrial" method="post"
		...
		<div align="center" class="divstyle">
			<b>Select a category that you would like to search.</b><br/><br/>
		...
		<div align="center" class="divstyle">
			<div class="spanstyle">
				<b>Type a <span class="categorystyle" id="catname"></span> query that you would enter into a search
					engine.  The documents you are searching are from 2009,<br/> and this search engine does not
