...
public class CreateHITSample {
	...
	private HITInfo createHIT(final String questionXmlFile) throws IOException {
		...
		List<Locale> localeValues = new ArrayList<Locale>();
		...
		request.setTitle("External: Answer a simple question");
		request.setKeywords("question, answer, research");
		request.setDescription("External: Answer a simple question");
