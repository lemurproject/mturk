...
public class GetAccountBalanceSample {
	...
	private HIT createHIT() {
		...
		createHITRequest.setDescription("Is this page: relevant or not relevant?");
		createHITRequest.setQuestion("questions.xml");
		createHITRequest.setReward("0.15");
		createHITRequest.setMaxAssignments(1);
		createHITRequest.setLifetimeInSeconds(172800l);
		createHITRequest.setAssignmentDurationInSeconds(600l);
		createHITRequest.setAutoApprovalDelayInSeconds(14400l);
		CreateHITResult createHITResult = client.createHIT(createHITRequest);
		return createHITResult.getHIT();
	}
}
